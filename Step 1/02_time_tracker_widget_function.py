...
an editable lunch break reminder   """
...
def update_clock():
    ...
    transmit_signal(f"Time Worked: {hours:02}:{minutes:02}:{seconds:02}\n"
                    f"Remaining Time: {remaining_time}", "Time Tracker")


def transmit_signal(message, title):
